import {
  ...
  EmphasisPackage, LinkPackage, Document, TablePackage, ListPackage
} from 'substance'
...
class StandaloneConfigurator extends Configurator {
  constructor() {
    ...
    this.import(TablePackage, defaultOptions)
    this.import(ListPackage, { toolGroup: 'overlay', disableCollapsedCursor: true })
    ...
    this.import(XrefPackage, defaultOptions)
